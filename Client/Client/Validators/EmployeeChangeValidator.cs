...
{
    class EmployeeChangeValidator : IValidate
    {
        private static EmployeeChangeValidator _instace;
        private Admin _window;
        protected EmployeeChangeValidator() { }

        public static EmployeeChangeValidator GetInstance(Admin window)
        {
            if (_instace == null)
            {
                _instace = new EmployeeChangeValidator();
            }
...
#pragma warning restore IDE0018 // Inline variable declaration
            ...
            {
                MessageBox.Show("Login zbyt krótki - minimum 5 znaków", "Bład", MessageBoxButton.OK);
                return false;
            }
